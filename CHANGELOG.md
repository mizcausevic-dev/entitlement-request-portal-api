...
### Released
- Shipped **entitlement-request-portal-api** as a public artifact for teams dealing with answer-engine visibility.
...
### Shipped
- Cut the first coherent internal version of **entitlement-request-portal-api** with stable domain objects, review surfaces, and decision outputs.
